...
def main():
    ...
    df_transpose = pd.read_csv('Data/Training_tensor_data/dimension_32/article_index_32.csv', header=None)
    df_tensors = pd.read_csv('Data/Training_tensor_data/dimension_32/sentence_tensors_32.csv', header=None)
    ##df_383 = pd.read_csv("Training data/tensorsBERT_383.csv")

    df_obj = DF_edit()
    save_to_location = 'Output_data/Results Data/Kmeans/dimension_32/art_ten_dim32_clus15.csv'
    ...
    save_to_location_cl = 'Data/Output_data/Results Data/Kmeans/dimension_32/cl_art_ten_dim32_clus15.csv'
    centroids.to_csv('Data/Output_data/Centroids/dimension_32/centroids_dim32_clus15.csv')
